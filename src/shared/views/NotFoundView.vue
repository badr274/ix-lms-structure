...
<template>
  <component :is="authStore.isAuthenticated ? AppLayout : 'div'" :title="'Page Not Found'">
    <div
      :class="[
        'flex flex-col items-center justify-center w-full max-w-2xl mx-auto py-8',
        !authStore.isAuthenticated && 'min-h-screen p-4 bg-sidebar text-foreground',
      ]"
    >
      <PageHeader
